...
DELETE FROM `dbscript_string` WHERE `entry` BETWEEN 2000001519 AND 2000001520;
INSERT INTO `dbscript_string` (`entry`, `content_default`, `sound`, `type`, `language`, `emote`, `comment`) VALUES 
(2000001519, 'Do you think the rumors about the Infinite Dragonflight are true?  I''ve sensed it... the familiarity.', 0, 0, 0, 1, 'Indormi (Entry: 23437)'),
(2000001520, 'That is a dangerous train of thought.  If something was truly amiss, Soridormi would be the first to know.', 0, 0, 0, 274, 'Tydormu (Entry: 23381)');

DELETE FROM `dbscripts_on_creature_movement` WHERE `id` IN(2338101);
INSERT INTO `dbscripts_on_creature_movement` (`id`,`delay`,`command`,`datalong`,`datalong2`,`datalong3`,`dataint`,`dataint2`,`dataint3`,`dataint4`,`buddy_entry`,`search_radius`,`data_flags`,`comments`,`x`,`y`,`z`,`o`) VALUES
(2338101,110,0,0,0,0,2000001519,0,0,0,23437,5,3,'Indormi - Do you think the rumors about the Infinite Dragonflight are true?  I''ve sensed it... the familiarity.',0,0,0,0),
(2338101,119,0,0,0,0,2000001520,0,0,0,0,0,0,'Tydormu - That is a dangerous train of thought.  If something was truly amiss, Soridormi would be the first to know.',0,0,0,0);
...
(1777201,1,0,0,0,0,2000001521,0,0,0,0,0,0,'Lady Jaina Proudmoore - %s begins channelling a massive teleport spell.',0,0,0,0),
(1777201,22,35,6,0,0,0,0,0,0,0,0,0,'Lady Jaina Proudmoore - Throw AI Event 6 on Self',0,0,0,0);

DELETE FROM `dbscript_string` WHERE `entry`=2000001521;
INSERT INTO `dbscript_string` (`entry`, `content_default`, `sound`, `type`, `language`, `emote`, `comment`) VALUES 
(2000001521, '%s begins channelling a massive teleport spell.', 0, 7, 0, 0, 'Lady Jaina Proudmoore (Entry: 17772)');
...
(@CAGUID+30,@CAGUID+1,1),
(@CAGUID+31,@CAGUID+1,1),
...
(1777202,3,0,0,0,0,2000001521,0,0,0,0,0,0,'Lady Jaina Proudmoore - %s begins channelling a massive teleport spell.',0,0,0,0),
...
(@CHGUID+41,@CHGUID+1,1),
(@CHGUID+5,@CHGUID+1,1),
(@CHGUID+6,@CHGUID+1,1),
(@CHGUID+42,@CHGUID+1,1),
...
(@CNGUID+12,@CNGUID+14,1|2), -- FLAG_AGGRO_ON_AGGRO, FLAG_TO_AGGRO_ON_AGGRO
-- 2 Archers at lower platform outside the big house
(@CNGUID+17,@CNGUID+16,1|2), -- FLAG_AGGRO_ON_AGGRO, FLAG_TO_AGGRO_ON_AGGRO
-- 2 Archers at lower platform outside the small house
(@CNGUID+19,@CNGUID+20,1|2), -- FLAG_AGGRO_ON_AGGRO, FLAG_TO_AGGRO_ON_AGGRO
-- 1 Dryad, 1 Claw, 1 Talon next to moonwell
(@CNGUID+9,@CNGUID+23,1|2), -- FLAG_AGGRO_ON_AGGRO, FLAG_TO_AGGRO_ON_AGGRO
(@CNGUID+5,@CNGUID+23,1|2), -- FLAG_AGGRO_ON_AGGRO, FLAG_TO_AGGRO_ON_AGGRO
-- 2 Night Elf Huntresses
(@CNGUID+35,@CNGUID+34,1|2|512), -- FLAG_AGGRO_ON_AGGRO, FLAG_TO_AGGRO_ON_AGGRO, FLAG_FOLLOW
-- 2 Night Elf Huntresses
(@CNGUID+37,@CNGUID+36,1|2|512), -- FLAG_AGGRO_ON_AGGRO, FLAG_TO_AGGRO_ON_AGGRO, FLAG_FOLLOW
-- 2 Dryads
(@CNGUID+25,@CNGUID+24,1|2|512), -- FLAG_AGGRO_ON_AGGRO, FLAG_TO_AGGRO_ON_AGGRO, FLAG_FOLLOW
-- Also link remaining npcs to Tyrande to make them spawn with her and not respawn individually if she's dead
(@CNGUID+5,@CNGUID+38,128|1024), -- FLAG_RESPAWN_ON_RESPAWN, FLAG_CANT_SPAWN_IF_BOSS_DEAD
(@CNGUID+9,@CNGUID+38,128|1024),
(@CNGUID+12,@CNGUID+38,128|1024),
(@CNGUID+14,@CNGUID+38,128|1024),
(@CNGUID+16,@CNGUID+38,128|1024),
(@CNGUID+17,@CNGUID+38,128|1024),
(@CNGUID+18,@CNGUID+38,128|1024),
(@CNGUID+19,@CNGUID+38,128|1024),
(@CNGUID+20,@CNGUID+38,128|1024),
(@CNGUID+23,@CNGUID+38,128|1024),
(@CNGUID+24,@CNGUID+38,128|1024),
(@CNGUID+25,@CNGUID+38,128|1024),
(@CNGUID+34,@CNGUID+38,128|1024),
(@CNGUID+35,@CNGUID+38,128|1024),
(@CNGUID+36,@CNGUID+38,128|1024),
(@CNGUID+37,@CNGUID+38,128|1024),
